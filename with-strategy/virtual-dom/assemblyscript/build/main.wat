(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 39328))
 (memory $0 1)
 ...
 (data $82 (i32.const 5884) "<")
 (data $82.1 (i32.const 5896) "\02\00\00\00$\00\00\00K\00e\00y\00 \00d\00o\00e\00s\00 \00n\00o\00t\00 \00e\00x\00i\00s\00t")
 (data $83 (i32.const 5948) ",")
 (data $83.1 (i32.const 5960) "\02\00\00\00\16\00\00\00~\00l\00i\00b\00/\00m\00a\00p\00.\00t\00s")
 (data $84 (i32.const 5996) "\1c")
 (data $84.1 (i32.const 6008) "\02\00\00\00\0c\00\00\00i\00g\00n\00o\00r\00e")
 (data $85 (i32.const 6028) "\1c")
 (data $85.1 (i32.const 6040) "\01")
 (data $86 (i32.const 6060) "\1c")
 (data $86.1 (i32.const 6072) "\01")
 (data $87 (i32.const 6092) "\1c")
 (data $87.1 (i32.const 6104) "\1a\00\00\00\08\00\00\00\01")
 (data $88 (i32.const 6124) "\1c")
 (data $88.1 (i32.const 6136) "\1a\00\00\00\08\00\00\00\02")
 (data $89 (i32.const 6156) "\1c")
 (data $89.1 (i32.const 6168) "\1a\00\00\00\08\00\00\00\03")
 (data $90 (i32.const 6188) "\1c")
 (data $90.1 (i32.const 6200) "\02\00\00\00\08\00\00\00 \00!\00!\00!")
 (data $91 (i32.const 6220) "\1c")
 (data $91.1 (i32.const 6232) "\1a\00\00\00\08\00\00\00\04")
 (data $92 (i32.const 6252) "\1c")
 (data $92.1 (i32.const 6264) "\1a\00\00\00\08\00\00\00\05")
 (data $93 (i32.const 6284) "\1c")
 (data $93.1 (i32.const 6296) "\1a\00\00\00\08\00\00\00\06")
 ...
 (data $96 (i32.const 6448) "\1b\00\00\00 \00\00\00 \00\00\00 ")
 (data $96.1 (i32.const 6472) "\10A\82\00\02A\00\00\00\00\00\00\02\t")
 (data $96.2 (i32.const 6496) "\02A\00\00\02A\00\00 \00\00\00\02A\00\00\02A\00\00\00\00\00\00\02A")
 (data $96.3 (i32.const 6544) "\02A")
 (table $0 7 7 funcref)
                 ...
                 block $~lib/string/String
                  block $~lib/arraybuffer/ArrayBuffer
                   block $~lib/object/Object
                    ...
                    i32.sub
                    i32.load $0
                    br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $folding-inner1 $~lib/map/Map<~lib/string/String,~lib/string/String> $folding-inner2 $folding-inner1 $~lib/array/Array<i32> $folding-inner1 $assembly/lib/models/element/VisiblePropsType $folding-inner2 $folding-inner2 $assembly/lib/models/patch.model/Patch $folding-inner2 $folding-inner2 $folding-inner3 $folding-inner2 $folding-inner1 $folding-inner3 $folding-inner3 $assembly/lib/models/list-diff2.model/DiffResult $assembly/lib/models/list-diff2.model/Move $folding-inner2 $folding-inner3 $folding-inner3 $~lib/function/Function<%28%29=>void> $invalid
                   end
                   return
                  end
                  return
 ...
 (func $assembly/lib/diff/diff (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 16
  i32.sub
