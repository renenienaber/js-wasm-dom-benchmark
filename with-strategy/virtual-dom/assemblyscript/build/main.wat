(module
 ...
 (data $80.1 (i32.const 5832) "\13\00\00\00\08\00\00\00\01")
 ...
 (data $88.1 (i32.const 6136) "\13\00\00\00\08\00\00\00\02")
 (data $89 (i32.const 6156) "\1c")
 (data $89.1 (i32.const 6168) "\13\00\00\00\08\00\00\00\03")
 (data $90 (i32.const 6188) "\1c")
 (data $90.1 (i32.const 6200) "\02\00\00\00\08\00\00\00 \00!\00!\00!")
 (data $91 (i32.const 6220) "\1c")
 (data $91.1 (i32.const 6232) "\13\00\00\00\08\00\00\00\04")
 (data $92 (i32.const 6252) "\1c")
 (data $92.1 (i32.const 6264) "\13\00\00\00\08\00\00\00\05")
 (data $93 (i32.const 6284) "\1c")
 (data $93.1 (i32.const 6296) "\13\00\00\00\08\00\00\00\06")
                 ...
                 block $~lib/string/String
                  block $~lib/arraybuffer/ArrayBuffer
                   block $~lib/object/Object
                    ...
                    i32.sub
                    i32.load $0
                    br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $folding-inner1 $~lib/map/Map<~lib/string/String,~lib/string/String> $folding-inner2 $folding-inner1 $~lib/array/Array<i32> $folding-inner1 $assembly/lib/models/element/VisiblePropsType $folding-inner2 $folding-inner2 $assembly/lib/models/patch.model/Patch $folding-inner2 $folding-inner2 $folding-inner3 $folding-inner2 $folding-inner1 $~lib/function/Function<%28%29=>void> $folding-inner3 $folding-inner3 $assembly/lib/models/list-diff2.model/DiffResult $assembly/lib/models/list-diff2.model/Move $folding-inner2 $folding-inner3 $folding-inner3 $invalid
                   end
                   return
                  end
                  return
