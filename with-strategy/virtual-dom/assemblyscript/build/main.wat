(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 39360))
 (memory $0 1)
 ...
 (data $80.1 (i32.const 5832) "\01")
 (data $81 (i32.const 5852) "\1c")
 (data $81.1 (i32.const 5864) "\13\00\00\00\08\00\00\00\01")
 ...
 (data $89.1 (i32.const 6168) "\13\00\00\00\08\00\00\00\02")
 (data $90 (i32.const 6188) "\1c")
 (data $90.1 (i32.const 6200) "\13\00\00\00\08\00\00\00\03")
 (data $91 (i32.const 6220) "\1c")
 (data $91.1 (i32.const 6232) "\02\00\00\00\08\00\00\00 \00!\00!\00!")
 (data $92 (i32.const 6252) "\1c")
 (data $92.1 (i32.const 6264) "\13\00\00\00\08\00\00\00\04")
 (data $93 (i32.const 6284) "\1c")
 (data $93.1 (i32.const 6296) "\13\00\00\00\08\00\00\00\05")
 (data $94 (i32.const 6316) "\1c")
 (data $94.1 (i32.const 6328) "\13\00\00\00\08\00\00\00\06")
 (data $95 (i32.const 6348) "<")
 (data $95.1 (i32.const 6360) "\02\00\00\00*\00\00\00O\00b\00j\00e\00c\00t\00 \00a\00l\00r\00e\00a\00d\00y\00 \00p\00i\00n\00n\00e\00d")
 (data $96 (i32.const 6412) "<")
 (data $96.1 (i32.const 6424) "\02\00\00\00(\00\00\00O\00b\00j\00e\00c\00t\00 \00i\00s\00 \00n\00o\00t\00 \00p\00i\00n\00n\00e\00d")
 (data $97 (i32.const 6480) "\1b\00\00\00 \00\00\00 \00\00\00 ")
 (data $97.1 (i32.const 6504) "\10A\82\00\02A\00\00\00\00\00\00\02\t")
 (data $97.2 (i32.const 6528) "\02A\00\00\02A\00\00\00\00\00\00\02A\00\00\00\00\00\00 \00\00\00\02A\00\00\02A")
 (data $97.3 (i32.const 6580) "\02A")
 (table $0 7 7 funcref)
 ...
 (export "testRun" (func $export:assembly/main/testRun))
 ...
 (func $assembly/lib/models/element/VisiblePropsType~visit (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load $0
  local.tee $1
          ...
          block $assembly/lib/models/list-diff2.model/DiffResult
           block $~lib/function/Function<%28%29=>void>
            block $assembly/lib/models/patch.model/Patch
             block $assembly/lib/models/element/VisiblePropsType
                 ...
                 block $~lib/string/String
                  block $~lib/arraybuffer/ArrayBuffer
                   block $~lib/object/Object
                    ...
                    i32.sub
                    i32.load $0
                    br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $folding-inner1 $~lib/map/Map<~lib/string/String,~lib/string/String> $folding-inner2 $folding-inner1 $~lib/array/Array<i32> $folding-inner1 $assembly/lib/models/element/VisiblePropsType $folding-inner2 $folding-inner2 $folding-inner3 $folding-inner2 $folding-inner1 $assembly/lib/models/patch.model/Patch $folding-inner2 $folding-inner2 $~lib/function/Function<%28%29=>void> $folding-inner3 $folding-inner3 $assembly/lib/models/list-diff2.model/DiffResult $assembly/lib/models/list-diff2.model/Move $folding-inner2 $folding-inner3 $folding-inner3 $invalid
                   end
                   return
                  end
                  return
             ...
             local.get $0
             call $assembly/lib/models/element/VisiblePropsType~visit
             return
            end
            return
           end
 ...
 (func $~lib/array/Array<assembly/lib/models/element/VElement>#constructor (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $~lib/array/Array<assembly/lib/models/element/VElement>#__set (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/lib/models/element/toVElement (param $0 i32) (result i32)
  ...
  block $folding-inner0
   ...
   global.get $~lib/memory/__stack_pointer
   local.get $2
   call $~lib/array/Array<assembly/lib/models/element/VElement>#constructor
   local.tee $5
   i32.store $0 offset=28
   loop $for-loop|03
    local.get $1
    ...
    if
     ...
     local.get $1
     local.get $6
     call $~lib/array/Array<assembly/lib/models/element/VElement>#__set
     local.get $1
     i32.const 1
     i32.add
     local.set $1
 ...
 (func $assembly/lib/models/element/_toVisiblePropsType (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $assembly/lib/models/element/toVisibleVElement (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  block $folding-inner0
   ...
   i32.store $0 offset=12
   local.get $4
   call $assembly/lib/models/element/_toVisiblePropsType
   local.set $4
   global.get $~lib/memory/__stack_pointer
   local.get $4
   i32.store $0 offset=8
   ...
   loop $for-loop|0
    ...
    if
     ...
     global.get $~lib/memory/__stack_pointer
     local.get $4
     call $assembly/lib/models/element/toVisibleVElement
     local.tee $4
     i32.store $0 offset=36
     global.get $~lib/memory/__stack_pointer
     local.get $3
 ...
 (func $export:assembly/main/testRun (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
