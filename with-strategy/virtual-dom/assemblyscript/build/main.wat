(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 39324))
 (memory $0 1)
 ...
 (data $80.1 (i32.const 5832) "\12\00\00\00\08\00\00\00\01")
 ...
 (data $88.1 (i32.const 6136) "\12\00\00\00\08\00\00\00\02")
 (data $89 (i32.const 6156) "\1c")
 (data $89.1 (i32.const 6168) "\12\00\00\00\08\00\00\00\03")
 (data $90 (i32.const 6188) "\1c")
 (data $90.1 (i32.const 6200) "\02\00\00\00\08\00\00\00 \00!\00!\00!")
 (data $91 (i32.const 6220) "\1c")
 (data $91.1 (i32.const 6232) "\12\00\00\00\08\00\00\00\04")
 (data $92 (i32.const 6252) "\1c")
 (data $92.1 (i32.const 6264) "\12\00\00\00\08\00\00\00\05")
 (data $93 (i32.const 6284) "\1c")
 (data $93.1 (i32.const 6296) "\12\00\00\00\08\00\00\00\06")
 ...
 (data $96 (i32.const 6448) "\1a\00\00\00 \00\00\00 \00\00\00 ")
 (data $96.1 (i32.const 6472) "\10A\82\00\02A\00\00\00\00\00\00\02\t\00\00\00\00\00\00\02A\00\00 \00\00\00\02A\00\00\02A\00\00\00\00\00\00\02A\00\00\02A")
 (data $96.2 (i32.const 6544) "\02A")
 (table $0 7 7 funcref)
 ...
 (func $assembly/main/_getVElementByVisibleElement (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  loop $for-loop|0
   ...
   if
    ...
    global.get $~lib/memory/__stack_pointer
    local.get $6
    call $assembly/main/_getVElementByVisibleElement
    local.tee $6
