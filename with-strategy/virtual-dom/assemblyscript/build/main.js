async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf({
    testRun(visibleElement) {
      // assembly/main/testRun(assembly/lib/models/element/VisibleVElement) => ~lib/array/Array<~lib/array/Array<assembly/lib/models/patch.model/Patch>>
      visibleElement = __lowerRecord9(visibleElement) || __notnull();
      return __liftArray(pointer => __liftArray(pointer => __liftRecord13(__getU32(pointer)), 2, __getU32(pointer)), 2, exports.testRun(visibleElement) >>> 0);
    },
